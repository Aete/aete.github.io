...
Promise.all([
   ...
   d3.csv('data/USA_MSA_aggregated_death.csv',  d3.autoType)
    ...
    lineChart(cases, d3.select('#cases-description'),'case', '2020-03-01','2020-05-14');
    lineChart(deaths, d3.select('#deaths-description'),'death','2020-03-01','2020-05-14');
});
...
Promise.all([
    ...
    map(caseMap,geoState,geoMSA, d3.select('#map'),'case');
});