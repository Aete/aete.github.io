...
const openLab = ` <h4 style = " margin-top : 0;">Open Lab</h4>
...
const Courtyard = ` <h4 style = " margin-top : 0;">Courtyard of Engineering Buildings</h4>
  ...
  <p style = "margin-top:0;">  In case of Engineering Building 2, there is atrium for pleasant envioronment. 
  In that place people can take a rest and have some culturalactivity in atrium.</p>
  <img src="image/collaboration/new/7.jpg">`;

const cafe = `<h4 style = " margin-top : 0;">Cafe & Restaurant</h4>
...
const sport = `<h4 style = " margin-top : 0;">Sport Facilities</h4>
  <p>This place can make some communities. In sport facility, people who have different
  major can communicate each other, and there are some possibilities to make creative thinking. <br></p>`;

const eng3 = ` <h4 style = " margin-top : 0;">Engineering Building 3</h4>
  ...
  There are also workshops, open lecture rooms and seminar rooms in lower part of building, and it is place for some exchanging program. 
  We can bring professors and students who is in other universities and it is will be another type of collaboration.</p>
  <img src="image/collaboration/new/9.jpg">`;

const gate = `<h4 style = " margin-top : 0;">New Entrance from South-East Side</h4>
